...
//  long get_daemon_max_peer_height(int handle);
  ...
  string get_unaudited_balance(int handle, bool locked_only);
  ...
  string get_unlocked_balance_account_asset(int handle, const string& asset_type, const uint32_t account_idx);
  string get_unlocked_balance_subaddress(int handle, const string& asset_type, const uint32_t account_idx, const uint32_t subaddress_idx);
